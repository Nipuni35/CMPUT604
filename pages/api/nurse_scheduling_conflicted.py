...
n_nurses = int(sys.argv[1])      # count nurses n = 1 ... n_nurses
n_days = int(sys.argv[2])      # count scheduling days as d = 1 ... n_days
...
conflict1 = []
conflict2 = []
conflictedNurses1 = sys.argv[4].split(',')
for w in conflictedNurses1:
    conflict1.append(int(w))
conflictedNurses2 = sys.argv[5].split(',')
for w in conflictedNurses2:
    conflict2.append(int(w))

# CONFLICTS = [(0,1,2), (3,4,5)]
CONFLICTS = [tuple(conflict1), tuple(conflict2)]
...
sampler = LeapHybridSampler(token="DEV-65c84cbc6704ae4ec1c519676e63f86538d4fa95")
